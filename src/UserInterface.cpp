...
namespace UI_Score {
    ...
    const char* BOARDS[4] = {
        "data\\38-Breakout-Tiles.png",
        "data\\31-Breakout-Tiles.png",
        "data\\39-Breakout-Tiles.png",
        "data\\40-Breakout-Tiles.png"
    };
    const int POINTS[4] = { 100, 50, 250, 500 };
    Sprite* displays[4] = { nullptr };
